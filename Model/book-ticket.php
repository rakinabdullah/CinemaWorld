          ...
          <div class="border-right">
            <div class="border-left">
              <div class="inner">
                ...
                <p class="p1">Film, also called movie, motion picture or moving picture, is a visual art used to simulate experiences that communicate ideas, stories, perceptions, feelings, beauty, or atmosphere through the use of moving images. These images are generally accompanied by sound, and more rarely, other sensory stimulations. The word «cinema», short for cinematography, is often used to refer to filmmaking and the film industry, and to the art form that is the result of it.<br>They reflect those cultures, and, in turn, affect them. Film is considered to be an important art form, a source of popular entertainment, and a powerful medium for educating—or indoctrinating—citizens. The visual basis of film gives it a universal power of communication. The perception of motion is partly due to a psychological effect called the phi phenomenon.
The name «film» originates from the fact that photographic film has historically been the medium for recording and displaying motion pictures.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="wrap-contact100">
      ...
      <form class="contact100-form validate-form" action="booking.php" method="post">
        ...
        <div class="wrap-input100 bg1 rs1-wrap-input100">
          ...
          <input class="input100" type="text" name="phone" placeholder="Enter Number Phone Number">
        </div>
        ...
        <div class="wrap-input100 bg1 rs1-wrap-input100">
		 ...
		 <div class="wrap-input100 bg1 rs1-wrap-input100">
          <span class="label-input100">Credit/Debit Card Number</span>
